...
import { CogIcon, MicrophoneIcon, PhoneIcon } from '@heroicons/react/outline';
...
const Home = () => {
    ...
    const handleAddChannel =() =>{
        ...
        const createChannelName = async (channelName) => {
            if (channelName){
    ...
    return (
        <>
          ...
          <div className='flex h-screen'>
              ...
              <div className='bg-discord_channlesBg flex flex-col min-w-max'> 
